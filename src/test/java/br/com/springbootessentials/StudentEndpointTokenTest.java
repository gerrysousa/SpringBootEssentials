...
public class StudentEndpointTokenTest {
  ...
  public void whenFindStudentByNameUsingIncorrectToken_thenReturnStatusCode403Forbidden () {
    ResponseEntity<String> response = restTemplate.exchange("/v1/protected/students/findByName/Maria", GET, wrongHeader, String.class);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenSaveStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/", POST, wrongHeader, String.class);
  ...
  public void whenSaveStudentUsingCorrectToken_thenReturn201Created () {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/", POST, adminHeader, String.class);
  ...
  public void whenDeleteStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden () {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/{id}", DELETE, wrongHeader, String.class, 1L);
  ...
  public void whenDeleteStudentUsingCorrectToken_thenReturnStatusCode200Ok () throws JSONException {
    ...
    ResponseEntity<String> response1 = restTemplate.exchange("/v1/admin/students/", POST, adminHeader, String.class);
    ...
    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/{id}", DELETE, adminHeader, String.class, studentJson.getLong("id"));
  ...
  public void whenUpdateStudentUsingCorrectToken_thenReturnStatusCode200Ok () throws JSONException {
    ...
    restTemplate.exchange("/v1/admin/students/", POST, adminHeader, String.class);

    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/", PUT, adminHeader, String.class);
  ...
  public void whenUpdateStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden () {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/v1/admin/students/", PUT, wrongHeader, String.class);
  ...
  public void whenFindStudentsByNameUsingCorrectRole_thenReturnStatusCode200 () throws Exception {
    ...
    mockMvc.perform(get("/v1/protected/students/findByName/legolas"))
        .andExpect(status().isOk())
        .andDo(print());
  ...
  public void whenDeleteUsingCorrectRole_thenReturnStatusCode200 () throws Exception {
    ...
    mockMvc.perform(delete("/v1/admin/students/{id}", 3))
        .andExpect(status().isOk())
        .andDo(print());
