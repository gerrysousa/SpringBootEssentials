...
public class StudentEndpointTokenTest {
  ...
  @WithMockUser(
      ...
      password = "xxx",
      roles = {"USER"})
  public void whenListStudentUsingCorrectToken_thenReturnStatusCode200OK() throws Exception {
    mockMvc.perform(get("/v1/protected/students/")).andExpect(status().isOk()).andDo(print());
  }
  ...
  @WithMockUser(
      ...
      password = "xxx",
      roles = {"ADMIN"})
  public void whenUpdateStudentUsingCorrectToken_thenReturnStatusCode200Ok() throws Exception {
    Student student = new Student(10L, "User initial", "update@lotr.com");
    ...
    student.setName("User Updated");
    ObjectMapper mapper = new ObjectMapper();
    String jsonString = mapper.writeValueAsString(student);
    mockMvc
        .perform(
            put("/v1/admin/students/").contentType(MediaType.APPLICATION_JSON).content(jsonString))
  ...
  public void whenFindStudentsByNameUsingCorrectRole_thenReturnStatusCode200() throws Exception {
    ...
    mockMvc
        .perform(get("/v1/protected/students/findByName/legolas"))
        .andExpect(status().isOk())
        .andDo(print());
  ...
  public void whenDeleteUsingCorrectRole_thenReturnStatusCode200() throws Exception {
    ...
    mockMvc.perform(delete("/v1/admin/students/{id}", 3)).andExpect(status().isOk()).andDo(print());
    verify(studentRepository).deleteById(3L);
  }

  @Test
  @WithMockUser(username = "xx", password = "xx", roles = "USER")
  public void whenListAllStudentsUsingCorrectRole_thenReturnCorrectData200() throws Exception {
    List<Student> students =
        asList(
            new Student(1L, "Legolas", "legolas@lotr.com"),
            new Student(2L, "Aragorn", "aragorn@lotr.com"));
    ...
    when(studentRepository.findAll(isA(Pageable.class))).thenReturn(pagedStudents);
    mockMvc
        .perform(get("/v1/protected/students/"))
  ...
  @WithMockUser(
      ...
      password = "xxx",
      roles = {"ADMIN"})
  public void whenSaveStudentUsingCorrectToken_thenReturn201Created() throws Exception {
    Student student = new Student(3L, "Sucess", "legolas@lotr.com");
    when(studentRepository.save(student)).thenReturn(student);
    ObjectMapper mapper = new ObjectMapper();
    String jsonString = mapper.writeValueAsString(student);
    mockMvc
        .perform(
            post("/v1/admin/students/").contentType(MediaType.APPLICATION_JSON).content(jsonString))
  ...
  public void whenListStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ResponseEntity<String> response =
        restTemplate.exchange("/v1/protected/students/", GET, wrongHeader, String.class);
  ...
  public void whenGetStudentByIdUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ResponseEntity<String> response =
        restTemplate.exchange("/v1/protected/students/1", GET, wrongHeader, String.class);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenFindStudentByNameUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ResponseEntity<String> response =
        restTemplate.exchange(
            "/v1/protected/students/findByName/Maria", GET, wrongHeader, String.class);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenSaveStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange("/v1/admin/students/", POST, wrongHeader, String.class);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenDeleteStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ResponseEntity<String> response =
        restTemplate.exchange("/v1/admin/students/{id}", DELETE, wrongHeader, String.class, 1L);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenUpdateStudentUsingIncorrectToken_thenReturnStatusCode403Forbidden() {
    ...
    adminHeader = new HttpEntity<>(student, adminHeader.getHeaders());
    ResponseEntity<String> response =
        restTemplate.exchange("/v1/admin/students/", PUT, wrongHeader, String.class);
    assertThat(response.getStatusCodeValue()).isEqualTo(403);
  }
  ...
  public void whenDeleteHasRoleUser_thenReturnStatusCode403() throws Exception {
    ...
    mockMvc
        .perform(delete("/v1/admin/students/{id}", 1))
  ...
  @WithMockUser(
      ...
      roles = {"USER"})
  public void
      whenGetStudentByIdUsingCorrectTokenAndStudentDontExist_thenReturnStatusCode404NotFound()
          throws Exception {
    mockMvc
        .perform(get("/v1/protected/students/-1"))
  ...
  @WithMockUser(
      ...
      password = "xxx",
      roles = {"USER"})
  public void whenGetStudentByIdUsingCorrectRoleAndStudentDoesntExist_thenReturnStatusCode404()
      throws Exception {
    Student student = new Student(3L, "Legolas", "legolas@lotr.com");
    when(studentRepository.findById(3L)).thenReturn(java.util.Optional.of(student));
    mockMvc
        .perform(get("/v1/protected/students/{id}", 6))
        .andExpect(status().isNotFound())
        .andDo(print());
